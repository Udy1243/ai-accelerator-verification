module gear_quantizer (clk,
 ...
 sky130_fd_sc_hd__inv_2 _240_ (.A(_189_),
    .Y(_190_));
 sky130_fd_sc_hd__buf_2 _241_ (.A(_190_),
    .X(_191_));
 sky130_fd_sc_hd__buf_2 _242_ (.A(net7),
    .X(_192_));
 sky130_fd_sc_hd__buf_2 _243_ (.A(net6),
    .X(_193_));
 sky130_fd_sc_hd__clkbuf_4 _244_ (.A(net5),
    .X(_194_));
 sky130_fd_sc_hd__buf_2 _245_ (.A(net3),
    .X(_195_));
 ...
 sky130_fd_sc_hd__nor2_2 _278_ (.A(_191_),
    .B(_227_),
    .Y(_228_));
 sky130_fd_sc_hd__o21ba_1 _279_ (.A1(net28),
    .A2(_189_),
    .B1_N(_228_),
    .X(_000_));
 ...
 sky130_fd_sc_hd__buf_2 _281_ (.A(net14),
    .X(_230_));
 sky130_fd_sc_hd__buf_2 _282_ (.A(net13),
    .X(_231_));
 ...
 sky130_fd_sc_hd__a22o_1 _295_ (.A1(_016_),
    ...
    .B2(_238_),
    .X(_018_));
 sky130_fd_sc_hd__nand4_1 _296_ (.A(_230_),
    .B(_231_),
    .C(_193_),
    .D(_194_),
    .Y(_019_));
 ...
 sky130_fd_sc_hd__a22o_1 _298_ (.A1(_020_),
    ...
    .B2(net14),
    .X(_021_));
 sky130_fd_sc_hd__nand4_1 _299_ (.A(_016_),
    .B(_192_),
    .C(_019_),
    .D(_021_),
    .Y(_022_));
 ...
 sky130_fd_sc_hd__xnor2_1 _314_ (.A(_229_),
    .B(_036_),
    .Y(_037_));
 sky130_fd_sc_hd__o21ai_1 _315_ (.A1(_029_),
    .A2(_032_),
    .B1(_037_),
    .Y(_038_));
 ...
 sky130_fd_sc_hd__a21bo_1 _353_ (.A1(_055_),
    ...
    .B1_N(_229_),
    .X(_076_));
 sky130_fd_sc_hd__and3_1 _354_ (.A(_058_),
    .B(_075_),
    .C(_076_),
    .X(_077_));
 sky130_fd_sc_hd__xnor2_1 _355_ (.A(_065_),
    .B(_077_),
    .Y(_078_));
 ...
 sky130_fd_sc_hd__a21o_1 _406_ (.A1(_124_),
    ...
    .B1(_126_),
    .X(_129_));
 sky130_fd_sc_hd__nor2b_1 _407_ (.A(_128_),
    .B_N(_129_),
    .Y(_130_));
 ...
 sky130_fd_sc_hd__a21oi_1 _409_ (.A1(_058_),
    ...
    .B1(_075_),
    .Y(_132_));
 sky130_fd_sc_hd__nor2_1 _410_ (.A(_077_),
    .B(_132_),
    .Y(_133_));
 ...
 sky130_fd_sc_hd__o211ai_2 _446_ (.A1(_049_),
    ...
    .C1(_168_),
    .Y(_169_));
 sky130_fd_sc_hd__or3b_1 _447_ (.A(_152_),
    .B(_167_),
    .C_N(_140_),
    .X(_170_));
 ...
 sky130_fd_sc_hd__buf_2 input8 (.A(data_in[7]),
    .X(net8));
 sky130_fd_sc_hd__clkbuf_1 input9 (.A(round_mode),
    .X(net9));
 ...
 sky130_fd_sc_hd__buf_2 input14 (.A(scale[3]),
    .X(net14));
 sky130_fd_sc_hd__clkbuf_1 input15 (.A(threshold[0]),
    .X(net15));
 sky130_fd_sc_hd__clkbuf_1 input16 (.A(threshold[1]),
    .X(net16));
 ...
 sky130_fd_sc_hd__buf_1 max_cap38 (.A(_152_),
    .X(net38));
 sky130_fd_sc_hd__clkbuf_4 fanout39 (.A(net10),
    .X(net39));
endmodule
