module gear_quantizer (clk,
 ...
 sky130_fd_sc_hd__buf_2 _221_ (.A(_169_),
    ...
    .VPWR(VPWR),
    .X(_170_));
 sky130_fd_sc_hd__buf_2 _222_ (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_171_));
 sky130_fd_sc_hd__buf_2 _223_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _271_ (.A(_204_),
    ...
    .VPWR(VPWR),
    .X(_013_));
 sky130_fd_sc_hd__nand2_1 _272_ (.A(net10),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _318_ (.A1(net12),
    ...
    .VPWR(VPWR),
    .X(_060_));
 sky130_fd_sc_hd__nand4_1 _319_ (.A(_205_),
    .B(_206_),
    .C(_171_),
    .D(_172_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _324_ (.A1(_049_),
    ...
    .VPWR(VPWR),
    .X(_066_));
 sky130_fd_sc_hd__and3_1 _325_ (.A(_055_),
    .B(_065_),
    .C(_066_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _344_ (.A(_052_),
    ...
    .VPWR(VPWR),
    .Y(_086_));
 sky130_fd_sc_hd__xor2_1 _345_ (.A(_067_),
    .B(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 input10 (.A(scale[0]),
    ...
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__clkbuf_2 input11 (.A(scale[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlymetal6s2s_1 input16 (.A(threshold[2]),
    ...
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__dlymetal6s2s_1 input17 (.A(threshold[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
