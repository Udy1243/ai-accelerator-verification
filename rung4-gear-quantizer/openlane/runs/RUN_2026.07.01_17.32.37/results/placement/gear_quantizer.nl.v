module gear_quantizer (clk,
 ...
 sky130_fd_sc_hd__o21ba_1 _255_ (.A1(net27),
    ...
    .B1_N(_203_),
    .X(_000_));
 sky130_fd_sc_hd__clkbuf_2 _256_ (.A(net10),
    .X(_204_));
 ...
 sky130_fd_sc_hd__nand4_1 _259_ (.A(_205_),
    ...
    .D(net5),
    .Y(_207_));
 sky130_fd_sc_hd__clkbuf_2 _260_ (.A(net11),
    .X(_208_));
 ...
 sky130_fd_sc_hd__and2b_1 _360_ (.A_N(_093_),
    .B(_092_),
    .X(_102_));
 sky130_fd_sc_hd__xnor2_1 _361_ (.A(_101_),
    .B(_102_),
    .Y(_103_));
 ...
 sky130_fd_sc_hd__clkbuf_2 input9 (.A(rst_n),
    .X(net9));
 sky130_fd_sc_hd__dlymetal6s2s_1 input10 (.A(scale[0]),
    .X(net10));
 ...
 sky130_fd_sc_hd__clkbuf_1 input14 (.A(threshold[0]),
    .X(net14));
 sky130_fd_sc_hd__clkbuf_1 input15 (.A(threshold[1]),
    .X(net15));
