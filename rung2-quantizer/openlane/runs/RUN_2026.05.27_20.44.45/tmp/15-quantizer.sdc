...
# Wed May 27 20:45:48 2026
###############################################################################
current_design quantizer
###############################################################################
# Timing Constraints
###############################################################################
...
set_input_delay 5.0000 -clock [get_clocks {clk}] -add_delay [get_ports {scale[4]}]
set_input_delay 5.0000 -clock [get_clocks {clk}] -add_delay [get_ports {scale[5]}]
set_input_delay 5.0000 -clock [get_clocks {clk}] -add_delay [get_ports {scale[6]}]
set_input_delay 5.0000 -clock [get_clocks {clk}] -add_delay [get_ports {scale[7]}]
...
set_output_delay 5.0000 -clock [get_clocks {clk}] -add_delay [get_ports {overflow}]
