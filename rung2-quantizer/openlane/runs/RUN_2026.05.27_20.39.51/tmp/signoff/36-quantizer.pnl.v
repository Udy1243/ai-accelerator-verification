module quantizer (VGND,
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_0_165 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_0_173 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_0_337 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_0_345 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_20_253 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_0_20_259 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_20_328 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_20_340 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_22_327 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_22_331 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_31_333 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_31_345 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_31_357 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_31_369 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_8 FILLER_0_31_381 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_32_317 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_32_334 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_33_353 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_33_365 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_33_377 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_35_325 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_35_341 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_35_353 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_35_365 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_35_377 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_38_327 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_38_339 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_38_351 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_40_15 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_0_40_155 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_42_195 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_3 FILLER_0_42_243 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_44_29 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_3 FILLER_0_44_295 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_46_27 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_4 FILLER_0_46_273 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_0_46_280 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_2 FILLER_0_47_169 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_47_175 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__decap_3 FILLER_0_47_221 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_0_47_235 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_48_336 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_48_348 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_50_15 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__decap_6 FILLER_0_50_166 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_59_329 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_59_33 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_59_81 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_ef_sc_hd__decap_12 FILLER_0_59_9 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_ef_sc_hd__decap_12 FILLER_0_60_377 (.VPWR(VPWR),
    ...
    .VPB(VPWR),
    .VNB(VGND));
 sky130_fd_sc_hd__fill_2 FILLER_0_60_389 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_0_64_373 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_ef_sc_hd__decap_12 FILLER_0_64_380 (.VPWR(VPWR),
    .VGND(VGND),
    .VPB(VPWR),
    .VNB(VGND));
 ...
 sky130_fd_sc_hd__buf_2 _0825_ (.A(net19),
    ...
    .VPWR(VPWR),
    .X(_0434_));
 sky130_fd_sc_hd__buf_4 _0826_ (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _0832_ (.A(net19),
    ...
    .VPWR(VPWR),
    .X(_0511_));
 sky130_fd_sc_hd__buf_6 _0833_ (.A(net23),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _0839_ (.A(_0467_),
    ...
    .VPWR(VPWR),
    .Y(_0588_));
 sky130_fd_sc_hd__buf_2 _0840_ (.A(net25),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 _0850_ (.A(net20),
    ...
    .VPWR(VPWR),
    .X(_0709_));
 sky130_fd_sc_hd__buf_6 _0851_ (.A(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0720_));
 sky130_fd_sc_hd__buf_4 _0852_ (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _0888_ (.A(_0698_),
    ...
    .VPWR(VPWR),
    .Y(_0023_));
 sky130_fd_sc_hd__buf_4 _0889_ (.A(net3),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _0907_ (.A(_0742_),
    ...
    .VPWR(VPWR),
    .Y(_0042_));
 sky130_fd_sc_hd__buf_6 _0908_ (.A(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0043_));
 sky130_fd_sc_hd__buf_6 _0909_ (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _0925_ (.A(_0056_),
    ...
    .VPWR(VPWR),
    .Y(_0060_));
 sky130_fd_sc_hd__buf_6 _0926_ (.A(net2),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _0941_ (.A(_0074_),
    ...
    .VPWR(VPWR),
    .Y(_0076_));
 sky130_fd_sc_hd__buf_6 _0942_ (.A(net22),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__or2_1 _0958_ (.A(_0060_),
    ...
    .VPWR(VPWR),
    .X(_0093_));
 sky130_fd_sc_hd__buf_6 _0959_ (.A(net11),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0094_));
 sky130_fd_sc_hd__buf_6 _0960_ (.A(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a31o_1 _0963_ (.A1(_0026_),
    ...
    .VPWR(VPWR),
    .X(_0098_));
 sky130_fd_sc_hd__buf_6 _0964_ (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _0971_ (.A(_0098_),
    ...
    .VPWR(VPWR),
    .X(_0106_));
 sky130_fd_sc_hd__nand2_1 _0972_ (.A(_0105_),
    .B(_0106_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0107_));
 sky130_fd_sc_hd__buf_6 _0973_ (.A(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a22o_1 _0975_ (.A1(net21),
    ...
    .VPWR(VPWR),
    .X(_0110_));
 sky130_fd_sc_hd__buf_8 _0976_ (.A(net21),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0111_));
 sky130_fd_sc_hd__buf_6 _0977_ (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0112_));
 sky130_fd_sc_hd__buf_6 _0978_ (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0113_));
 sky130_fd_sc_hd__nand4_4 _0979_ (.A(_0043_),
    .B(net75),
    .C(_0112_),
    .D(_0113_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a22o_1 _0983_ (.A1(net21),
    ...
    .VPWR(VPWR),
    .X(_0118_));
 sky130_fd_sc_hd__buf_6 _0984_ (.A(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0119_));
 sky130_fd_sc_hd__nand4_4 _0985_ (.A(_0043_),
    .B(net75),
    .C(_0113_),
    .D(_0119_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21bo_1 _0992_ (.A1(_0122_),
    ...
    .VPWR(VPWR),
    .X(_0127_));
 sky130_fd_sc_hd__buf_6 _0993_ (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _1012_ (.A(_0107_),
    ...
    .VPWR(VPWR),
    .Y(_0147_));
 sky130_fd_sc_hd__nor3_4 _1013_ (.A(_0144_),
    .B(_0145_),
    .C(_0147_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0148_));
 sky130_fd_sc_hd__buf_6 _1014_ (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _1030_ (.A1(_0156_),
    ...
    .VPWR(VPWR),
    .X(_0165_));
 sky130_fd_sc_hd__and3_1 _1031_ (.A(_0163_),
    .B(_0164_),
    .C(_0165_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _1041_ (.A(_0100_),
    ...
    .VPWR(VPWR),
    .Y(_0176_));
 sky130_fd_sc_hd__or3_4 _1042_ (.A(_0166_),
    .B(_0167_),
    .C(_0176_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0177_));
 sky130_fd_sc_hd__o21ai_2 _1043_ (.A1(net53),
    .A2(_0167_),
    .B1(_0176_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a211oi_2 _1046_ (.A1(_0103_),
    ...
    .VPWR(VPWR),
    .Y(_0181_));
 sky130_fd_sc_hd__o211a_1 _1047_ (.A1(_0179_),
    .A2(_0180_),
    .B1(_0103_),
    .C1(_0107_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _1063_ (.A1(_0126_),
    ...
    .VPWR(VPWR),
    .X(_0198_));
 sky130_fd_sc_hd__nand3_4 _1064_ (.A(_0183_),
    .B(net89),
    .C(net88),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1074_ (.A(_0207_),
    ...
    .VPWR(VPWR),
    .Y(_0209_));
 sky130_fd_sc_hd__or3_4 _1075_ (.A(_0200_),
    .B(_0201_),
    .C(_0209_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _1076_ (.A1(_0144_),
    ...
    .VPWR(VPWR),
    .X(_0211_));
 sky130_fd_sc_hd__a211o_1 _1077_ (.A1(_0199_),
    .A2(_0210_),
    .B1(_0211_),
    .C1(_0148_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _1078_ (.A(_0203_),
    ...
    .VPWR(VPWR),
    .Y(_0213_));
 sky130_fd_sc_hd__a211oi_4 _1079_ (.A1(_0199_),
    .A2(net83),
    .B1(_0211_),
    .C1(_0148_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _1080_ (.A1(_0148_),
    ...
    .VPWR(VPWR),
    .X(_0215_));
 sky130_fd_sc_hd__a211o_4 _1081_ (.A1(_0213_),
    .A2(_0207_),
    .B1(_0214_),
    .C1(_0215_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0216_));
 sky130_fd_sc_hd__o211ai_1 _1082_ (.A1(_0181_),
    .A2(_0182_),
    .B1(_0212_),
    .C1(net85),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_2 _1112_ (.A1(_0200_),
    ...
    .VPWR(VPWR),
    .Y(_0247_));
 sky130_fd_sc_hd__o211a_4 _1113_ (.A1(_0234_),
    .A2(_0246_),
    .B1(_0247_),
    .C1(net82),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2b_1 _1114_ (.A(_0241_),
    ...
    .VPWR(VPWR),
    .X(_0249_));
 sky130_fd_sc_hd__a211oi_4 _1115_ (.A1(net82),
    .A2(_0247_),
    .B1(_0246_),
    .C1(_0234_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0250_));
 sky130_fd_sc_hd__a211oi_4 _1116_ (.A1(_0249_),
    .A2(_0243_),
    .B1(_0248_),
    .C1(_0250_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211ai_2 _1117_ (.A1(_0214_),
    ...
    .VPWR(VPWR),
    .Y(_0252_));
 sky130_fd_sc_hd__o211a_1 _1118_ (.A1(_0248_),
    .A2(_0251_),
    .B1(_0216_),
    .C1(_0252_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o211a_1 _1120_ (.A1(_0181_),
    ...
    .VPWR(VPWR),
    .X(_0255_));
 sky130_fd_sc_hd__a211oi_2 _1121_ (.A1(net79),
    .A2(_0252_),
    .B1(_0248_),
    .C1(_0251_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211o_1 _1149_ (.A1(_0274_),
    ...
    .VPWR(VPWR),
    .X(_0284_));
 sky130_fd_sc_hd__o211ai_2 _1150_ (.A1(net43),
    .A2(_0283_),
    .B1(_0282_),
    .C1(_0274_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _1178_ (.A(_0294_),
    ...
    .VPWR(VPWR),
    .X(_0313_));
 sky130_fd_sc_hd__or3_4 _1179_ (.A(_0310_),
    .B(_0311_),
    .C(_0313_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a211o_1 _1182_ (.A1(_0315_),
    ...
    .VPWR(VPWR),
    .X(_0317_));
 sky130_fd_sc_hd__a21bo_1 _1183_ (.A1(net67),
    .A2(_0316_),
    .B1_N(_0317_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _1198_ (.A(_0108_),
    ...
    .VPWR(VPWR),
    .X(_0333_));
 sky130_fd_sc_hd__a22o_1 _1199_ (.A1(net75),
    .A2(net8),
    .B1(net1),
    .B2(_0077_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ai_1 _1238_ (.A1(_0310_),
    ...
    .VPWR(VPWR),
    .Y(_0373_));
 sky130_fd_sc_hd__and3_4 _1239_ (.A(_0314_),
    .B(_0372_),
    .C(_0373_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_2 _1243_ (.A(net42),
    ...
    .VPWR(VPWR),
    .Y(_0378_));
 sky130_fd_sc_hd__nand3_1 _1244_ (.A(net67),
    .B(_0317_),
    .C(_0316_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a41o_1 _1249_ (.A1(_0371_),
    ...
    .VPWR(VPWR),
    .X(_0385_));
 sky130_fd_sc_hd__nand4_2 _1250_ (.A(net78),
    .B(_0323_),
    .C(_0325_),
    .D(_0385_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_0386_));
 sky130_fd_sc_hd__nor3_1 _1251_ (.A(net53),
    .B(_0167_),
    .C(_0176_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or3_1 _1279_ (.A(_0406_),
    ...
    .VPWR(VPWR),
    .X(_0418_));
 sky130_fd_sc_hd__o211a_1 _1280_ (.A1(net56),
    .A2(_0387_),
    .B1(_0417_),
    .C1(_0418_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_0419_));
 sky130_fd_sc_hd__o211ai_1 _1281_ (.A1(net55),
    .A2(_0387_),
    .B1(_0417_),
    .C1(_0418_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _1306_ (.A(_0379_),
    ...
    .VPWR(VPWR),
    .X(_0448_));
 sky130_fd_sc_hd__nand2_1 _1307_ (.A(net68),
    .B(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _1321_ (.A1(_0420_),
    ...
    .VPWR(VPWR),
    .Y(_0464_));
 sky130_fd_sc_hd__or2_1 _1322_ (.A(_0424_),
    .B(_0464_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0465_));
 sky130_fd_sc_hd__or2_1 _1323_ (.A(_0179_),
    .B(_0181_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0466_));
 sky130_fd_sc_hd__xnor2_1 _1324_ (.A(_0465_),
    .B(_0466_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor3_1 _1328_ (.A(_0444_),
    ...
    .VPWR(VPWR),
    .Y(_0472_));
 sky130_fd_sc_hd__and2_1 _1329_ (.A(net68),
    .B(_0448_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3b_1 _1480_ (.A(_0631_),
    ...
    .VPWR(VPWR),
    .X(_0639_));
 sky130_fd_sc_hd__a311o_1 _1481_ (.A1(net66),
    .A2(_0556_),
    .A3(_0560_),
    .B1(_0623_),
    .C1(_0639_),
 ...
 sky130_fd_sc_hd__and2_1 _1512_ (.A(_0652_),
    ...
    .VPWR(VPWR),
    .X(_0674_));
 sky130_fd_sc_hd__or3b_4 _1513_ (.A(_0671_),
    .B(_0672_),
    .C_N(_0674_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_0675_));
 sky130_fd_sc_hd__a31o_1 _1514_ (.A1(net66),
    .A2(_0556_),
    .A3(_0560_),
    .B1(_0623_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _1524_ (.A(_0622_),
    ...
    .VPWR(VPWR),
    .Y(_0688_));
 sky130_fd_sc_hd__a31o_1 _1525_ (.A1(net47),
    .A2(_0556_),
    .A3(_0560_),
    .B1(_0688_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand4_1 _1531_ (.A(_0686_),
    ...
    .VPWR(VPWR),
    .Y(_0695_));
 sky130_fd_sc_hd__nand2_2 _1532_ (.A(net60),
    .B(net46),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21bo_1 _1536_ (.A1(_0696_),
    ...
    .VPWR(VPWR),
    .X(_0701_));
 sky130_fd_sc_hd__xnor2_2 _1537_ (.A(net69),
    .B(_0701_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0702_));
 sky130_fd_sc_hd__nor2_1 _1538_ (.A(net45),
    .B(net70),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_0703_));
 sky130_fd_sc_hd__nor2_1 _1539_ (.A(net51),
    .B(_0256_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or3_1 _1564_ (.A(_0716_),
    ...
    .VPWR(VPWR),
    .X(_0732_));
 sky130_fd_sc_hd__or4_4 _1565_ (.A(_0699_),
    .B(_0702_),
    .C(_0714_),
    .D(_0732_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _1567_ (.A(_0550_),
    ...
    .VPWR(VPWR),
    .Y(_0735_));
 sky130_fd_sc_hd__or4_4 _1568_ (.A(_0684_),
    .B(_0695_),
    .C(_0733_),
    .D(_0735_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor4_2 _1578_ (.A(_0675_),
    ...
    .VPWR(VPWR),
    .Y(_0747_));
 sky130_fd_sc_hd__o22a_4 _1579_ (.A1(_0675_),
    .A2(_0736_),
    .B1(_0745_),
    .B2(_0746_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _1594_ (.A1(_0733_),
    ...
    .VPWR(VPWR),
    .X(_0765_));
 sky130_fd_sc_hd__o22a_4 _1595_ (.A1(net39),
    .A2(_0748_),
    .B1(_0755_),
    .B2(_0765_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or3b_4 _1600_ (.A(net38),
    ...
    .VPWR(VPWR),
    .X(_0771_));
 sky130_fd_sc_hd__or2b_4 _1601_ (.A(_0771_),
    .B_N(_0766_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_0772_));
 sky130_fd_sc_hd__buf_6 _1602_ (.A(_0772_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _1622_ (.A1(_0771_),
    ...
    .VPWR(VPWR),
    .X(_0790_));
 sky130_fd_sc_hd__mux2_1 _1623_ (.A0(net77),
    .A1(_0790_),
    .S(net27),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold33 (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__dlygate4sd3_1 hold34 (.A(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 input10 (.A(data_in[3]),
    ...
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__buf_2 input11 (.A(data_in[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__clkbuf_4 input12 (.A(data_in[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 input13 (.A(data_in[6]),
    ...
    .VPWR(VPWR),
    .X(net13));
 sky130_fd_sc_hd__buf_4 input14 (.A(data_in[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__buf_2 input15 (.A(data_in[8]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 input18 (.A(rst_n),
    ...
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__buf_4 input19 (.A(scale[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 input2 (.A(data_in[10]),
    ...
    .VPWR(VPWR),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_2 input20 (.A(scale[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net20));
 sky130_fd_sc_hd__buf_12 input21 (.A(scale[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__buf_6 input22 (.A(scale[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net22));
 sky130_fd_sc_hd__buf_4 input23 (.A(scale[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 input25 (.A(scale[6]),
    ...
    .VPWR(VPWR),
    .X(net25));
 sky130_fd_sc_hd__clkbuf_2 input26 (.A(scale[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 input9 (.A(data_in[2]),
    ...
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_1 max_cap1 (.A(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 max_cap38 (.A(net39),
    ...
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkbuf_1 max_cap40 (.A(net81),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 output37 (.A(net37),
    ...
    .VPWR(VPWR),
    .X(valid_out));
 sky130_fd_sc_hd__buf_1 rebuffer1 (.A(_0254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__buf_1 rebuffer10 (.A(_0166_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__buf_1 rebuffer11 (.A(net53),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__clkbuf_1 rebuffer12 (.A(net54),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__clkbuf_1 rebuffer13 (.A(net54),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__clkbuf_1 rebuffer14 (.A(_0376_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__buf_1 rebuffer15 (.A(_0468_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net58));
 sky130_fd_sc_hd__clkbuf_1 rebuffer16 (.A(net65),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__clkbuf_1 rebuffer17 (.A(_0322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__clkbuf_1 rebuffer18 (.A(_0215_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net61));
 sky130_fd_sc_hd__clkbuf_1 rebuffer19 (.A(_0182_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net62));
 sky130_fd_sc_hd__clkbuf_1 rebuffer2 (.A(net44),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__clkbuf_1 rebuffer20 (.A(_0547_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__clkbuf_1 rebuffer21 (.A(net63),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__clkbuf_1 rebuffer22 (.A(_0733_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__clkbuf_2 rebuffer23 (.A(_0552_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__buf_1 rebuffer24 (.A(_0294_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer25 (.A(_0216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__clkbuf_1 rebuffer26 (.A(_0510_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__clkbuf_1 rebuffer27 (.A(_0255_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer28 (.A(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__clkbuf_2 rebuffer29 (.A(_0257_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__clkbuf_1 rebuffer3 (.A(_0386_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__clkbuf_2 rebuffer30 (.A(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net82));
 sky130_fd_sc_hd__clkbuf_1 rebuffer31 (.A(_0381_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__buf_6 rebuffer32 (.A(_0210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer33 (.A(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net84));
 sky130_fd_sc_hd__buf_6 rebuffer34 (.A(_0216_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net85));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer35 (.A(_0552_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net86));
 sky130_fd_sc_hd__clkbuf_1 rebuffer36 (.A(_0116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net87));
 sky130_fd_sc_hd__dlymetal6s4s_1 rebuffer37 (.A(_0198_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net88));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer38 (.A(_0197_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__clkbuf_1 rebuffer4 (.A(net86),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__clkbuf_1 rebuffer5 (.A(_0385_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__clkbuf_1 rebuffer6 (.A(_0374_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__buf_1 rebuffer7 (.A(_0253_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__clkbuf_1 rebuffer8 (.A(net50),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net51));
 sky130_fd_sc_hd__clkbuf_1 rebuffer9 (.A(net51),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlymetal6s2s_1 split25 (.A(_0113_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__dlymetal6s2s_1 split28 (.A(_0112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__buf_1 split29 (.A(_0149_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__clkbuf_2 split30 (.A(_0128_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__buf_8 split32 (.A(_0111_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__clkbuf_2 wire39 (.A(_0747_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
